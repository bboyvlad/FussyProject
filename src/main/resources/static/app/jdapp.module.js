...
/******************************/
jdApp.service('helperFunc', ['userResource', 'shopcartResource', '$http', '$rootScope', '$location', function (userResource, shopcartResource, $http, $rootScope, $location) {
    ...
    this.hasRole = function (roles) {
        ...
        if( angular.isDefined($rootScope.user.authorities)){
            var rol = false
            console.log(roles);
            angular.forEach(roles, function (value, key) {
                console.log(value);
                var indexOfRole = value.indexOf($rootScope.user.authorities[0].authority);
