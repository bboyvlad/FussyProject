...
mycaptain.controller('MyCaptainController', ['$rootScope','$scope', '$http', '$location', 'myJdMenu', 'LxNotificationService', 'helperFunc', 'mycaptainResource', 'LxDialogService',
    function MyCaptainController($rootScope, $scope, $http, $location, myJdMenu, LxNotificationService, helperFunc, mycaptainResource, LxDialogService) {
        ...
        $scope.openDialogCaptain = function openDialogCaptain(ef_cap)
        {
            ...
            $scope.editmaster = {
                id: ef_cap.id, name: ef_cap.name, license: ef_cap.license, dateofbirth: ef_cap.dateofbirth, address: ef_cap.address, city: ef_cap.city, country: ef_cap.country, phone: ef_cap.phone, email: ef_cap.email, active: ef_cap.active ? 'true' : 'false'
            };
            $scope.feditcaptain = angular.copy($scope.editmaster);
            /***************** TO RECALL DATA ON EDIT FORMS ********************/
