...
public class PrincipalController {
    ...
    public @ResponseBody Object login( Authentication usr){
        System.out.println(" Nombre de usuarios: " +usr.getName());
    ...
    public @ResponseBody Object checkEmail(@PathVariable String email){
        ...
        if(!principalExist(email)){
            message.put("message","validEmail");
        }else{
            message.put("message","invalidEmail");
        }
        return message;
    }*/
    ...
    public @ResponseBody Object addcard(@RequestBody RegisterPayTransactionDTO regpay,
                                        Authentication auth) {
        ...
        /*Verifico si el aircraft le pertenece a este usuario*/
        if (!checked[0]){
    ...
    public @ResponseBody Object addpayment(@RequestBody Paymethod payadd,Authentication auth){
    ...
    public @ResponseBody Object addItemCart(@RequestBody ShopcartDTO flight,
        ...
        try{
            ...
            principalRepository.save(p).getCart().add(cart);
    ...
    public @ResponseBody void getRpt1(HttpServletResponse httpServletResponse) throws JRException, IOException {
...
//        FacesContext.getCurrentInstance().responseComplete();
        ...
        try{
            ...
            myaircrafts.forEach((aircraft)->{
                if((aircraft.getId() == aircraftid)){
                    ...
                    System.out.println(airselected[0].getSeries() + "avion");
                }
            });
    ...
    public @ResponseBody Object updateMyaircraft(Authentication auth,
    ...
    boolean principalExist(String email){
        //System.out.println("findbyEmail restul:" + principalRepository.findByEmail(email));
