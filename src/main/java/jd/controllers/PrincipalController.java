...
public class PrincipalController {
    ...
    public @ResponseBody Object create(@RequestBody Principal user,
        ...
        try {
            ...
            if(!principalExist(user.getEmail())){
                ...
                message.put("messaje","Este email ya se encuentra registrado");
                return message;
            }
    ...
    public @ResponseBody Object checkEmail(@PathVariable String email){
        ...
        if(!principalExist(email)){
            message.put("messaje","Email OK");
        }else{
            message.put("messaje","Email Exist");
        }
        return message;
    }
    ...
    public @ResponseBody Object validateCoordenada(Authentication auth,
        ...
        try {
            ...
            if(usrAct.getCoordinates().isActive()){
                ...
                if (val1 && val2){
                    message.put("messaje","Autorized");
                }else{
                    message.put("messaje","Unautorized");
                }
                return message;
            }

            message.put("messaje","Coordinate card inactive");
            return message;
    ...
    * */
    ...
    public @RequestBody List<Servicerequest> shoyMyServicesRequests(){
